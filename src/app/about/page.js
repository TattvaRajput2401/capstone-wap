  ...
  return (
    <div style={{ background: 'var(--background)', color: 'var(--foreground)', minHeight: '100vh' }}>
      ...
      <section style={{ maxWidth: '900px', margin: '0 auto 40px auto', padding: '0 20px' }}>
        <h2 style={{ color: '#4CAF50', fontSize: '1.7rem', marginBottom: '12px', textAlign: 'left' }}>
          Our History
        </h2>
        <p style={{ color: '#B0B0B0', fontSize: '1.1rem', lineHeight: '1.7', textAlign: 'left' }}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h3 style={{ color: '#4CAF50', fontSize: '1.3rem', marginBottom: '10px' }}>Our Mission</h3>
          <p style={{ color: '#B0B0B0', fontSize: '1.05rem' }}>
        ...
        <div style={{
          ...
          <h3 style={{ color: '#4CAF50', fontSize: '1.3rem', marginBottom: '10px' }}>Our Vision</h3>
          <p style={{ color: '#B0B0B0', fontSize: '1.05rem' }}>
          ...
          >
            {teamMembers.map((member, idx) => (
              ...
              >
                ...
                />
                <h4 style={{ color: '#4CAF50', margin: '8px 0 4px 0', fontSize: '1.1rem' }}>{member.name}</h4>
                <p style={{ color: '#B0B0B0', fontWeight: 'bold', margin: '0 0 8px 0', fontSize: '1rem' }}>{member.role}</p>
                <p style={{ color: '#B0B0B0', fontSize: '0.98rem', margin: 0 }}>{member.bio}</p>
              </div>
            ))}
          </div>
          <button
        ...
        <div style={{
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              ...
              <li><Link href="/contact" style={{ color: '#B0B0B0', textDecoration: 'none' }}>Contact</Link></li>
          ...
          <div>
            ...
            <p style={{ margin: 0, color: '#B0B0B0' }}>info@nutritiontracker.com</p>
          </div>
          <div>
